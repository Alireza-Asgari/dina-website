...
const items = [
  ...
  },
  {
    ...
    description:
      "به شما کمک می‌کنیم تا در موتورهای جستجو بهتر دیده شوید و ترافیک وبسایت‌تان را به طور قابل توجهی افزایش دهید. این فرآیند شامل بهینه‌سازی محتوا، استفاده از کلمات کلیدی مناسب و بهبود ساختار وبسایت می‌باشد.",
  },
  {
    icon: <GrUpdate />,
    header: "به روزرسانی و پشتیبانی مستمر",
    description:
      "در دنیای فناوری با به‌روزرسانی‌ های مستمرمحصولاتمان به شما  کمک می‌کنیم تا همیشه یک قدم جلوتر باشید. بهبود امنیت و  افزودن ویژگی‌های جدیدبا هدف کارایی و بهینه سازی نرم افزارها،رسالت ماست.",
  },
  {
    icon: <CgWebsite />,
    header: "تخصص و خلاقیت در تولید و اجرا",
    description:
      "یک تجربه ی فوق العاده ، هدیه به مشتریان شما ! طراحی و توسعه وبسایت‌های کاربرپسندوجذاب، تخصص ماست. با بهره‌گیری از جدیدترین فناوری‌ها، وبسایت‌هایی با عملکرد بی‌نظیر برای شما خلق می‌کنیم.",
  },
];
const variants = {
