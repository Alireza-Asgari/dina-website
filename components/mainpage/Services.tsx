  ...
  return (
    <section className="pt-14 pb-20 relative overflow-hidden w-full text-primary-900 dark:text-white">
      ...
      <div className="relative ">
        <div className="mx-auto  sm:mx-16 w-fit grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mt-20 max-sm:w-full justify-items-center">
          <div className="relative w-72 lg:w-80 lg:h-80 z-10 bg-white-300 dark:bg-gray-800 p-6 rounded-e-[19px] space-y-6 transition-all hover:border-s-4 hover:scale-110 hover:border-primary-200 dark:hover:border-primary-300 border border-transparent group ">
